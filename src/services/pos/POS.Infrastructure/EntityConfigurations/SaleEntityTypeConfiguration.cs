...
public class SaleEntityTypeConfiguration : IEntityTypeConfiguration<Sale>
{
    public void Configure(EntityTypeBuilder<Sale> builder)
    {
        ...
        builder.Property(s => s.Balance).HasPrecision(18, 2).IsRequired();
        ...
        builder.Property(s => s.BuyerId).HasConversion<string>();
        builder.Property(s => s.PaymentMethodId).HasConversion<string>();
        builder.Property(s => s.AddressId).HasConversion<string>();
        builder.Property(s => s.CardTypeId).HasConversion<string>();
