...
namespace TossErp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251007070206_AddPhase4Extensions")]
    partial class AddPhase4Extensions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Ecommerce.OnlineOrder", b =>
                {
                    ...
                    b.Property<int?>("LinkedSalesOrderId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.BillOfMaterials", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.BomItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ComponentSku")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<int?>("SubstituteBomId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.BomOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("PrecedingOperationId")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("RunTimePerUnit")
                        .HasPrecision(10, 4)
                    ...
                    b.ToTable("BomOperations", (string)null);
                });

            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.ProductionEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("QualityInspectionStatus")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ReworkRequired")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.WorkOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.WorkOrderMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.WorkOrderOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("EstimatedRunTime")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)");

                    b.Property<decimal>("EstimatedSetupTime")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Marketing.Campaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Projects.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Projects.ProjectTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.SupplyChain.Carrier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("MinimumShipmentValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.SupplyChain.Shipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.SupplyChain.ShipmentItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.SupplyChain.ShipmentTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ShipmentTrackingHistory", (string)null);
                });

            modelBuilder.Entity("TossErp.Domain.Entities.WMS.BinLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BinLocations", (string)null);
                });
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.BomItem", b =>
                {
                    b.HasOne("TossErp.Domain.Entities.Manufacturing.BillOfMaterials", "BillOfMaterials")
                        .WithMany("Items")
                        .HasForeignKey("BomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Manufacturing.ProductionEntry", b =>
                {
                    b.HasOne("TossErp.Domain.Entities.Manufacturing.WorkOrder", "WorkOrder")
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.Projects.ProjectTask", b =>
                {
                    b.HasOne("TossErp.Domain.Entities.Projects.Project", "Project")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("TossErp.Domain.Entities.SupplyChain.ShipmentItem", b =>
                {
                    b.HasOne("TossErp.Domain.Entities.SupplyChain.Shipment", "Shipment")
                        .WithMany("Items")
