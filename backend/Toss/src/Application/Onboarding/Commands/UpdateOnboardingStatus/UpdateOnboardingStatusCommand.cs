...
public record UpdateOnboardingStatusCommand : IRequest<int>
{
...
public class UpdateOnboardingStatusCommandHandler : IRequestHandler<UpdateOnboardingStatusCommand, int>
{
    ...
    public async Task<int> Handle(UpdateOnboardingStatusCommand request, CancellationToken cancellationToken)
    {
