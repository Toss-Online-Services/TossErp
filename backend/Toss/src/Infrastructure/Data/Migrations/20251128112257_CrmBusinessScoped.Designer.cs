...
namespace Toss.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251128112257_CrmBusinessScoped")]
    partial class CrmBusinessScoped
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Accounting.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Accounting.CashbookEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BusinessId", "EntryDate");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Accounting.VendorLedgerEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Businesses.Business", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Businesses.UserBusiness", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.CRM.CustomerInteraction", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "InteractionDate");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Logistics.Driver", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "IsActive", "IsAvailable");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Onboarding.OnboardingStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Orders.PurchaseDocumentLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PurchaseDocumentLines", (string)null);
                });
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Orders.PurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ShopId", "PRNumber")
                        .IsUnique();

                    b.ToTable("PurchaseRequests");
                });

            modelBuilder.Entity("Toss.Domain.Entities.Orders.PurchaseRequestLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Toss.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Accounting.Account", b =>
                {
                    b.HasOne("Toss.Domain.Entities.Businesses.Business", "Business")
                        .WithMany()
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Accounting.CashbookEntry", b =>
                {
                    b.HasOne("Toss.Domain.Entities.Accounting.Account", "Account")
                        .WithMany("Entries")
                    ...
                    b.HasOne("Toss.Domain.Entities.Accounting.Account", "CounterpartyAccount")
                        .WithMany()
                        .HasForeignKey("CounterpartyAccountId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Toss.Domain.Entities.Payments.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Accounting.VendorLedgerEntry", b =>
                {
                    ...
                    b.HasOne("Toss.Domain.Entities.Orders.PurchaseDocument", "PurchaseDocument")
                        .WithMany()
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Orders.PurchaseDocumentLine", b =>
                {
                    ...
                    b.HasOne("Toss.Domain.Entities.Orders.PurchaseOrderItem", "PurchaseOrderItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Toss.Domain.Entities.Orders.PurchaseRequestLine", b =>
                {
                    b.HasOne("Toss.Domain.Entities.Catalog.Product", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Toss.Domain.Entities.Orders.PurchaseRequest", "PurchaseRequest")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Toss.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.HasOne("Toss.Infrastructure.Identity.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
