...
<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <div>
        <Breadcrumbs />
        <h1 class="text-2xl md:text-3xl font-bold tracking-tight mt-2">Sales Orders</h1>
        <p class="text-muted-foreground mt-1">Manage customer orders and quotes</p>
      </div>
      <Button>
    ...
    <Card>
      ...
      <CardContent>
        ...
        <div v-else-if="orders.length === 0" class="text-center py-12 text-muted-foreground">
          ...
          <p>No orders found</p>
          <p class="text-sm mt-1">Create your first sales order to get started</p>
        </div>
