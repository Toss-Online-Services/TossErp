...
const chat_post = defineEventHandler(async (event) => {
      ...
      responses: [
        {
          ...
          text: "\u{1F4CA} **Business Performance Analysis**\n\n**Strengths**:\n\u2022 \u{1F4C8} Sales up 23% vs last month\n\u2022 \u{1F3AF} Customer retention rate: 87%\n\u2022 \u{1F4B0} Profit margin improved to 34%\n\n**Opportunities**:\n\u2022 \u{1F6D2} Group buying could save R2,500/month on bulk items\n\u2022 \u{1F4F1} Mobile payment options could increase sales by 15%\n\u2022 \u{1F91D} 3 nearby businesses interested in shared delivery\n\n**Action Items**:\n1. Join the community flour group purchase (saves 18%)\n2. Set up mobile payment with SnapScan\n3. Contact Nomsa's Hardware about shared logistics\n\nShall I help you implement any of these recommendations?",
          data: {
            salesGrowth: 23,
            retentionRate: 87,
            profitMargin: 34,
  ...
  function getResponseType(message2) {
    const messageLower = message2.toLowerCase();
  ...
  const chatResponse = {
    ...
    language: "en",
    // Could be detected or specified
    confidence: 0.95
  };
  return {
    success: true,
