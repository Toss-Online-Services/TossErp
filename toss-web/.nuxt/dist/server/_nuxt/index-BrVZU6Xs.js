...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50 dark:bg-gray-900" }, _attrs))}><div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="py-4"><div class="flex items-center justify-between"><div><h1 class="text-2xl font-bold text-gray-900 dark:text-white"> Welcome back, ${ssrInterpolate(unref(userStore).user?.firstName)}! </h1><p class="text-gray-600 dark:text-gray-400">Overview of ${ssrInterpolate(unref(userStore).user?.businessName || "your business")} performance and key metrics</p></div><div class="flex space-x-3"><button class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"><span class="inline-block w-5 h-5 mr-2">📊</span> Generate Report </button></div></div></div></div></div><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6"><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8"><div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600 dark:text-gray-400">Revenue This Month</p><p class="text-2xl font-bold text-green-600">R ${ssrInterpolate(formatCurrency(unref(metrics).revenue))}</p><p class="text-sm text-green-600 mt-1">↗ +12.5% from last month</p></div><div class="p-3 bg-green-100 dark:bg-green-900 rounded-full"><span class="text-2xl">💰</span></div></div></div><div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600 dark:text-gray-400">Active Customers</p><p class="text-2xl font-bold text-blue-600">${ssrInterpolate(unref(metrics).customers)}</p><p class="text-sm text-blue-600 mt-1">↗ +8.2% from last month</p></div><div class="p-3 bg-blue-100 dark:bg-blue-900 rounded-full"><span class="text-2xl">👥</span></div></div></div><div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600 dark:text-gray-400">Inventory Value</p><p class="text-2xl font-bold text-purple-600">R ${ssrInterpolate(formatCurrency(unref(metrics).inventory))}</p><p class="text-sm text-red-600 mt-1">↘ -3.1% from last month</p></div><div class="p-3 bg-purple-100 dark:bg-purple-900 rounded-full"><span class="text-2xl">📦</span></div></div></div><div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"><div class="flex items-center justify-between"><div><p class="text-sm text-gray-600 dark:text-gray-400">Group Buy Savings</p><p class="text-2xl font-bold text-orange-600">R ${ssrInterpolate(formatCurrency(unref(metrics).savings))}</p><p class="text-sm text-orange-600 mt-1">↗ +24.8% from last month</p></div><div class="p-3 bg-orange-100 dark:bg-orange-900 rounded-full"><span class="text-2xl">🤝</span></div></div></div></div><div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8"><div class="lg:col-span-2"><div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"><div class="p-6 border-b border-gray-200 dark:border-gray-700"><h3 class="text-lg font-semibold text-gray-900 dark:text-white">Revenue Overview</h3></div><div class="p-6"><div class="h-64 flex items-center justify-center bg-gray-50 dark:bg-gray-700 rounded-lg"><p class="text-gray-500 dark:text-gray-400">Revenue chart would be displayed here</p></div></div></div></div><div><div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700"><div class="p-6 border-b border-gray-200 dark:border-gray-700"><h3 class="text-lg font-semibold text-gray-900 dark:text-white">Quick Actions</h3></div><div class="p-6"><div class="space-y-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-2xl"${_scopeId}>📦</span><div${_scopeId}><p class="font-medium text-gray-900 dark:text-white"${_scopeId}>Check Inventory</p><p class="text-sm text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(unref(lowStockItems))} items low on stock</p></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-2xl"${_scopeId}>🤝</span><div${_scopeId}><p class="font-medium text-gray-900 dark:text-white"${_scopeId}>Join Group Buys</p><p class="text-sm text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(unref(activeGroupBuys))} active opportunities</p></div>`);
          } else {
            return [
              createVNode("span", { class: "text-2xl" }, "🤝"),
              createVNode("div", null, [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-2xl"${_scopeId}>👥</span><div${_scopeId}><p class="font-medium text-gray-900 dark:text-white"${_scopeId}>Manage Customers</p><p class="text-sm text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(unref(pendingLeads))} leads need follow-up</p></div>`);
          } else {
            return [
              createVNode("span", { class: "text-2xl" }, "👥"),
              createVNode("div", null, [
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-2xl"${_scopeId}>💰</span><div${_scopeId}><p class="font-medium text-gray-900 dark:text-white"${_scopeId}>View Financials</p><p class="text-sm text-gray-600 dark:text-gray-400"${_scopeId}>${ssrInterpolate(unref(overduelnvoices))} overdue invoices</p></div>`);
          } else {
            return [
              createVNode("span", { class: "text-2xl" }, "💰"),
              createVNode("div", null, [
...
//# sourceMappingURL=index-BrVZU6Xs.js.map
