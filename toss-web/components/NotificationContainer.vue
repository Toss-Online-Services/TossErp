      ...
      >
        <div class="flex items-start space-x-3">
          <div class="flex-shrink-0">
            <IconBase :class="getIconClasses(notification.type)">
...
const notifications = ref<Notification[]>([
  {
    ...
    actions: [
      { label: 'View Details', action: () => navigateTo('/group-buying'), primary: true },
  ...
  },
  {
    ...
    actions: [
      { label: 'View Inventory', action: () => navigateTo('/inventory'), primary: true },
      { label: 'Dismiss', action: () => {} }
    ]
  }
])
