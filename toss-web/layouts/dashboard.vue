  ...
  <div class="flex min-h-screen bg-muted/50">
    ...
    <transition name="fade">
      ...
      >
        ...
        <aside class="relative z-50 flex w-80 flex-col bg-background pb-6 pt-6 shadow-lg">
          <div class="px-6">
          ...
          <nav class="mt-6 flex-1 overflow-y-auto px-4">
                  ...
                  <div v-if="item.children?.length" class="space-y-1">
                    ...
                    <transition name="collapse">
                      <div
                        ...
                        class="space-y-1 border-l border-muted pl-4"
                      >
                        <NuxtLink
    ...
    <!-- Desktop sidebar -->
    <aside class="hidden w-80 flex-col border-r bg-background pb-6 pt-6 shadow-sm md:flex">
      <div class="px-6">
        <p class="text-sm font-semibold text-primary">TOSS ERP</p>
        <p class="text-xl font-bold tracking-tight">Material Shadcn</p>
      </div>
      ...
      <header class="sticky top-0 z-30 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div class="flex h-16 items-center justify-between px-4 md:px-8">
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-2 rounded-full border bg-card px-2 py-1">
