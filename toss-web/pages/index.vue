  ...
  <div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg p-8 text-white">
      <div class="max-w-4xl">
        ...
        <p class="text-xl mb-6 text-blue-100">
          AI-powered collaborative business platform for South African SMMEs
        </p>
        <div class="flex flex-wrap gap-4">
          <NuxtLink to="/dashboard" class="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
            Go to Dashboard
          </NuxtLink>
          <NuxtLink to="/getting-started" class="border border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors">
            Getting Started
          </NuxtLink>
        </div>
      </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
      <div class="flex items-center mb-4">
        ...
        <div>
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white">AI Business Co-Pilot</h2>
          <p class="text-gray-600 dark:text-gray-400">Your intelligent business assistant</p>
        </div>
      </div>
      <p class="text-gray-700 dark:text-gray-300 mb-4">
        Chat with your AI assistant to manage inventory, check sales, coordinate with suppliers, and automate routine tasks. 
        Available in English, Afrikaans, Zulu, Xhosa, and more.
      </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-2xl font-semibold text-gray-900 dark:text-white">R 8,450</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Group Orders</p>
    ...
    <!-- ERP Modules Grid -->
    <div>
      <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Business Modules</h2>
      ...
      <div class="space-y-4">
        <div class="flex items-center space-x-3">
          ...
          <p class="text-sm text-gray-700 dark:text-gray-300">
            <span class="font-medium">Group purchase</span> completed - 5 businesses saved R2,340 on bulk flour order
          </p>
        ...
        <div class="flex items-center space-x-3">
          ...
          <p class="text-sm text-gray-700 dark:text-gray-300">
            <span class="font-medium">Inventory alert</span> - AI reordered 50kg maize meal automatically
          </p>
        ...
        <div class="flex items-center space-x-3">
          ...
          <p class="text-sm text-gray-700 dark:text-gray-300">
            <span class="font-medium">Tool sharing</span> - Drill borrowed by Thabo's Hardware for weekend project
          </p>
