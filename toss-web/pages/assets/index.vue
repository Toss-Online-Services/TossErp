...
<template>
  <div class="p-4 md:p-6">
    <div class="mb-6">
      <h1 class="mb-2 text-2xl font-bold">Asset Management</h1>
      <p class="text-muted-foreground">Track and manage business assets</p>
    </div>

    <!-- Stats Grid -->
    <div class="grid grid-cols-2 gap-4 mb-6 md:grid-cols-4">
      <UCard v-for="stat in stats" :key="stat.label" class="transition-shadow hover:shadow-md">
    ...
    <UCard>
      ...
      <div class="space-y-3">
        <div v-for="asset in recentAssets" :key="asset.id" class="p-4 transition-colors border rounded-lg hover:bg-accent/50">
          <div class="flex items-start justify-between mb-2">
            ...
            <div class="text-right">
              <p class="text-lg font-bold">R{{ (asset.value / 1000).toFixed(0) }}k</p>
